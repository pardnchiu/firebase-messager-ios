...
extension UIColor {
	...
	public var ciColor	: CIColor { return CIColor(color: self) };
	public var r		: CGFloat { return (self.ciColor.red * 255.cgFloat) };
	public var g		: CGFloat { return (self.ciColor.green * 255.cgFloat) };
	public var b		: CGFloat { return (self.ciColor.blue  * 255.cgFloat) };
	public var a		: CGFloat { return (self.ciColor.alpha) };
